<div class="card">
    ...
    ?>
        ...
        <div class="form-group row">
                <div class="col-md-6">
                    <label>MANCINIK AÇ KAPA</label>

                    <select name="CATAPULT_C" class="form-control">
                    <option <?php if($sData['catapult_c'] == 0){ echo "selected"; } ?> value="0">AYARLANMADI</option>
                    <option <?php if($sData['catapult_c'] == 1){ echo "selected"; } ?> value="1">AÇIK</option>
                    <option <?php if($sData['catapult_c'] == 2){ echo "selected"; } ?> value="2">KAPALI</option>
                 </select>
                </div>
