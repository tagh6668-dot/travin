...
$captchaError = "گپچا اشتباه است";

if(isset($_POST['s1'])){

    if(empty($_POST['captcha']) || !isset($_SESSION['captcha']) || strtolower($_POST['captcha']) != strtolower($_SESSION['captcha'])){
                    ...
                    <div id="content" class="signup"><h1 class="titleInHeader"><?php echo REG; ?></h1>
                        ...
                        <form name="snd" method="post" action="anmelden.php">
                            ...
                            <table cellpadding="0" cellspacing="0" align="center">
                                ...
                                <td>
                                    <input class="text" type="text" name="name" placeholder="<?=anlm0?>" value="<?php echo $form->getValue('name'); ?>" maxlength="15" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input class="text" type="text" name="captcha" maxlength="5">
