...
class Ranking
{
    ...
    public function procRankArray()
    {
        global $database;
        $holder = array();
        $q = "SELECT users.id as userid,users.access, users.username,users.alliance,users.location,users.apall,users.dpall,users.tribe, (
        ...
        foreach ($datas as $result) {
            ...
            $value['atpo'] = $result['apall'];
            $value['defpo'] = $result['dpall'];
            $value['tribe'] = $result['tribe'];
            array_push($holder, $value);
        }
    ...
    private function procAttRankArray()
    {
        ...
        $q = "SELECT users.id userid, users.tribe tribe, users.username username, users.apall,   (
    ...
    private function procDefRankArray()
    {
        ...
        $holder = array();
        $q = "SELECT users.id userid, users.tribe tribe,  users.username username, users.dpall,  (
