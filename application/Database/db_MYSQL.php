...
$q = $this->queryFetch("SELECT username,password FROM users WHERE username='".$username."' OR email='".$username."' LIMIT 1");
...
$check = md5($password.mb_convert_case($dbuser,MB_CASE_LOWER,"UTF-8"));
