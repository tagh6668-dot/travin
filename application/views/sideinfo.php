        ...
        <div class="sidebarBoxInnerBox">
            ...
            <div class="innerBox content">
                <ul>
                    ...
                    if(ARTEFACTS>time()) {
                        echo "<li>کتیبه ها آزاد میشوند: <span class=\"timer\" counting=\"down\" value=\"".(ARTEFACTS-time())."\">".$generator->getTimeFormat((ARTEFACTS-time()))."</span> ساعت.</li>";
                     }
                     if(WW_PLAN>time()) {
                        echo "<li>شگفتی جهان آزاد میشود: <span class=\"timer\" counting=\"down\" value=\"".(WW_PLAN-time())."\">".$generator->getTimeFormat((WW_PLAN-time()))."</span> ساعت.</li>";
                     }
			...
			<li class=""><a style="color: red; font-weight: bold" href="/nachrichten.php?t=1&id=6"> ► پشتیبانی</a></li>
