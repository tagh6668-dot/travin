...
if(!isset($_GET['t']) || !in_array($_GET['t'],array(1,2,3,4,5))){
    ?>
    <div class="clear"></div>
    <h4 class="round">Private trade</h4>
    <div class="whereAreMyMerchants">
    <?php //Market Object ( [onsale] => Array ( ) [onmarket] => Array ( [0] => Array ( [id] => 1 [vref] => 23838 [gtype] => 1 [gamt] => 100 [wtype] => 2 [wamt] => 200 [accept] => 0 [maxtime] => 0 [alliance] => 0 [merchant] => 1 ) [1] => Array ( [id] => 2 [vref] => 23838 [gtype] => 1 [gamt] => 1000 [wtype] => 2 [wamt] => 2000 [accept] => 0 [maxtime] => 0 [alliance] => 0 [merchant] => 1 ) ) [sending] => Array ( ) [recieving] => Array ( ) [return] => Array ( ) [maxcarry] => 1000000 [merchant] => 3 [used] => 2 ) Free trading: ‎1/3 ‎
 ?>
    Free trading: &lrm;<?php echo $market->merchantAvail(); ?>/<?php echo $market->merchant; ?>    &lrm;<br>
    Dealers in a market: &lrm;<?php echo count($market->onmarket); ?>/<?php echo $market->merchant; ?>    &lrm;<br>
    Dealers On the road: &lrm;<?php echo count($market->return) + count($market->sending); ?>/<?php echo $market->merchant; ?>    &lrm;
</div>
<div class="npcMerchant">
     Redistribute your resources in a Your village Using dealer swap right now at a 1: 1 ratio.<br>
    <button type="button" class="gold exchange " id="buttonm7"><div class="button-container addHoverClick">
        ...
        <div class="clear"></div>
        <h4 class="round">Trading routes</h4>
    <?php
