...
if($bindicate == 88 || $session->goldclub && $building->master==0 && $bindicate < 8) {
    if($bindicate != 88){echo "</br><br>";}
        if($id <= 18) {
            echo "<button type=\"button\" value=\"Upgrade level\" class=\"gold builder ".($session->gold < 999999 ? 'disabled' : '')."\" ".($session->gold < 999999 ? "onclick=\"window.location.href = 'dorf1.php?а=$id&c=$session->checker'; return false;\"" : '')." >
    	<div class=\"button-container addHoverClick\" style=\"margin:1px -3px;\">
            <div class=\"button-background\">
                <div class=\"buttonStart\">
                    <div class=\"buttonEnd\">
