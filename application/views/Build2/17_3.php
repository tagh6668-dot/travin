...
<script language="JavaScript">var summe=<?php echo floor($village->awood+$village->acrop+$village->airon+$village->aclay); ?>;var max123=<?php echo $village->maxstore; ?>;var max4=<?php echo $village->maxcrop; ?>;</script>
	...
	<?php
		...
		<p id="submitButton">
	<?php if($session->gold >= 3) { ?><a href="javascript:document.snd.submit();"><?=market43?></a> <span class="none">(<?=market40?>: <img src="img/x.gif" class="gold_g" alt="Gold" title="Gold" /><b>3</b>)</span><?php } else { echo"<span class='none'>".market43."</span> (Costs: <img src='img/x.gif' class='gold' alt='Gold' title='Gold' /><b>3</b>)"; }?>	</p>
		<p id="submitText"></p>
		</form>
		<script>
			testSum();
