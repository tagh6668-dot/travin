            ...
            if(count($routes) == 0) {
                ...
                foreach($routes as $route){
                    ...
                    <tr>
                        ...
                        <th><a href="build.php?id=<?php echo $id; ?>&t=4&action=editRoute&routeid=<?php echo $route['id']; ?>">» <?=market48?></a></th>
                    </tr>
                <?php }} ?>
            </tbody></table>
        <br>
        <div class="options">
            <a class="arrow" href="build.php?id=<?php echo $_GET['id']; ?>&s=17&t=4&create"> <?=market49?></a>
        </div>
