...
if($x ==0){ echo'<div class="none">ساختمان‌ها نمی‌توانند همزمان ساخته شوند. بیشتر ساختمان‌ها برای ساخت نیاز به پیش‌نیازهای اولیه دارند؛ برای اطلاعات بیشتر راهنما را ببینید.</div>'; }
...
if($x ==0){ echo'<div class="none">مجموعه‌ای از ساختمان‌ها جستجو شد. <br> شما می‌توانید ساختمان‌های خود را به سطح‌های بالاتری ارتقا دهید..</div>'; }
