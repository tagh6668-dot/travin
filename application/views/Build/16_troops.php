            ...
            <div class="sup"><div class="inlineIconList supplyWrapper"><div class="inlineIcon resources"><span class="value "><?php echo $database->getUpkeep($village->unitarray,$tribe,$village->resarray); ?></span><i class="r4"></i></div></div>&nbsp;per hour</div>
            </td></tr>
