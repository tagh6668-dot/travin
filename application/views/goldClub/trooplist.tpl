<?php
    ...
    <?php }elseif ($session->tribe == 4) { ?>
        <div class="troops">
            <div class="troopGroup">
                <label for="t1"><img class="unit u31" title="<?php echo u31; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t1" type="text" name="t1" value="<?php if ($t1 != 0) {
                    echo $t1;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t2"><img class="unit u32" title="<?php echo u32; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t2" type="text" name="t2" value="<?php if ($t2 != 0) {
                    echo $t2;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t3"><img class="unit u33" title="<?php echo u33; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t3" type="text" name="t3" value="<?php if ($t3 != 0) {
                    echo $t3;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t4"><img class="unit u34" title="<?php echo u34; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t4" type="text" name="t4" value="<?php if ($t4 != 0) {
                    echo $t4;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t5"><img class="unit u35" title="<?php echo u35; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t5" type="text" name="t5" value="<?php if ($t5 != 0) {
                    echo $t5;
                } else {
                    echo 0;
            ...
            <div class="clear"></div>
            <div class="troopGroup">
                <label for="t6"><img class="unit u36" title="<?php echo u36; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t6" type="text" name="t6" value="<?php if ($t6 != 0) {
                    echo $t6;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t7"><img class="unit u37" title="<?php echo u37; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t7" type="text" name="t7" value="<?php if ($t7 != 0) {
                    echo $t7;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t8"><img class="unit u38" title="<?php echo u38; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t8" type="text" name="t8" value="<?php if ($t8 != 0) {
                    echo $t8;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t9"><img class="unit u39" title="<?php echo u39; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t9" type="text" name="t9" value="<?php if ($t9 != 0) {
                    echo $t9;
                } else {
                    echo 0;
    ...
    <?php }elseif ($session->tribe == 5) { ?>
        <div class="troops">
            <div class="troopGroup">
                <label for="t1"><img class="unit u41" title="<?php echo u41; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t1" type="text" name="t1" value="<?php if ($t1 != 0) {
                    echo $t1;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t2"><img class="unit u42" title="<?php echo u42; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t2" type="text" name="t2" value="<?php if ($t2 != 0) {
                    echo $t2;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t3"><img class="unit u43" title="<?php echo u43; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t3" type="text" name="t3" value="<?php if ($t3 != 0) {
                    echo $t3;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t4"><img class="unit u44" title="<?php echo u44; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t4" type="text" name="t4" value="<?php if ($t4 != 0) {
                    echo $t4;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t5"><img class="unit u45" title="<?php echo u45; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t5" type="text" name="t5" value="<?php if ($t5 != 0) {
                    echo $t5;
                } else {
                    echo 0;
            ...
            <div class="clear"></div>
            <div class="troopGroup">
                <label for="t6"><img class="unit u46" title="<?php echo u46; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t6" type="text" name="t6" value="<?php if ($t6 != 0) {
                    echo $t6;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t7"><img class="unit u47" title="<?php echo u47; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t7" type="text" name="t7" value="<?php if ($t7 != 0) {
                    echo $t7;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t8"><img class="unit u48" title="<?php echo u48; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t8" type="text" name="t8" value="<?php if ($t8 != 0) {
                    echo $t8;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t9"><img class="unit u49" title="<?php echo u49; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t9" type="text" name="t9" value="<?php if ($t9 != 0) {
                    echo $t9;
                } else {
                    echo 0;
