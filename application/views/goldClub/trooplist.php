<?php
    ...
    <?php }elseif ($session->tribe == 6) { ?>
        <div class="troops">
            <div class="troopGroup">
                <label for="t1"><img class="unit u51" title="<?php echo u51; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t1" type="text" name="t1" value="<?php if ($t1 != 0) {
                    echo $t1;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t2"><img class="unit u52" title="<?php echo u52; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t2" type="text" name="t2" value="<?php if ($t2 != 0) {
                    echo $t2;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t3"><img class="unit u53" title="<?php echo u53; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t3" type="text" name="t3" value="<?php if ($t3 != 0) {
                    echo $t3;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t4"><img class="unit u54" title="<?php echo u54; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t4" type="text" name="t4" value="<?php if ($t4 != 0) {
                    echo $t4;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t5"><img class="unit u55" title="<?php echo u55; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t5" type="text" name="t5" value="<?php if ($t5 != 0) {
                    echo $t5;
                } else {
                    echo 0;
            ...
            <div class="clear"></div>
            <div class="troopGroup">
                <label for="t6"><img class="unit u56" title="<?php echo u56; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t6" type="text" name="t6" value="<?php if ($t6 != 0) {
                    echo $t6;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t7"><img class="unit u57" title="<?php echo u57; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t7" type="text" name="t7" value="<?php if ($t7 != 0) {
                    echo $t7;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t8"><img class="unit u58" title="<?php echo u58; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t8" type="text" name="t8" value="<?php if ($t8 != 0) {
                    echo $t8;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t9"><img class="unit u59" title="<?php echo u59; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t9" type="text" name="t9" value="<?php if ($t9 != 0) {
                    echo $t9;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t10"><img class="unit u60" title="<?php echo U60; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t10" type="text" name="t10" value="<?php if ($t10 != 0) {
                    echo $t10;
                } else {
                    echo 0;
    ...
    <?php }elseif ($session->tribe == 7) { ?>
        <div class="troops">
            <div class="troopGroup">
                <label for="t1"><img class="unit u61" title="<?php echo u61; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t1" type="text" name="t1" value="<?php if ($t1 != 0) {
                    echo $t1;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t2"><img class="unit u62" title="<?php echo u62; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t2" type="text" name="t2" value="<?php if ($t2 != 0) {
                    echo $t2;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t3"><img class="unit u63" title="<?php echo u63; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t3" type="text" name="t3" value="<?php if ($t3 != 0) {
                    echo $t3;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t4"><img class="unit u64" title="<?php echo u64; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t4" type="text" name="t4" value="<?php if ($t4 != 0) {
                    echo $t4;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t5"><img class="unit u65" title="<?php echo u65; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t5" type="text" name="t5" value="<?php if ($t5 != 0) {
                    echo $t5;
                } else {
                    echo 0;
            ...
            <div class="clear"></div>
            <div class="troopGroup">
                <label for="t6"><img class="unit u66" title="<?php echo u66; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t6" type="text" name="t6" value="<?php if ($t6 != 0) {
                    echo $t6;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t7"><img class="unit u67" title="<?php echo u67; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t7" type="text" name="t7" value="<?php if ($t7 != 0) {
                    echo $t7;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t8"><img class="unit u68" title="<?php echo u68; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t8" type="text" name="t8" value="<?php if ($t8 != 0) {
                    echo $t8;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t9"><img class="unit u69" title="<?php echo u69; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t9" type="text" name="t9" value="<?php if ($t9 != 0) {
                    echo $t9;
                } else {
                    echo 0;
            ...
            <div class="troopGroup">
                <label for="t10"><img class="unit u70" title="<?php echo U70; ?>" src="img/x.gif"></label>
                <input class="text troop" id="t10" type="text" name="t10" value="<?php if ($t10 != 0) {
                    echo $t10;
                } else {
                    echo 0;
