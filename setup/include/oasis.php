        ...
        $speed=OASISX;
			...
			switch($type) {
				...
				case 2:
					...
					$q = "UPDATE units SET u1 = u1 + '".$speed*rand(120,450)."',u2 = u2 + '".$speed*rand(104,289)."',u3 = u3 + '".$speed*rand(90,180)."',u4 = u4 + '".$speed*rand(80,160)."',u5 = u5 + '".$speed*rand(60,120)."',u6 = u6 + '".$speed*rand(49,60)."', u7 = u7 + '".$speed*rand(30,50)."',u8 = u8 + '".$speed*rand(20,40)."',u9 = u9 + '".$speed*rand(25,40)."',u10 = u10 + '".$speed*rand(7,20)."',u11 = u11 + '".$speed*rand(3,19)."' WHERE vref = '" . $wid . "'";
                    $q2 = "UPDATE units SET u1 = u1 + '".$speed*rand(120,450)."',u2 = u2 + '".$speed*rand(104,289)."',u3 = u3 + '".$speed*rand(90,180)."',u4 = u4 + '".$speed*rand(80,160)."',u5 = u5 + '".$speed*rand(60,120)."',u6 = u6 + '".$speed*rand(49,60)."', u7 = u7 + '".$speed*rand(30,50)."',u8 = u8 + '".$speed*rand(20,40)."',u9 = u9 + '".$speed*rand(25,40)."',u10 = u10 + '".$speed*rand(7,20)."',u11 = u11 + '".$speed*rand(3,19)."' WHERE vref = '" . $wid . "'";
					$database->query($q2); 
                $database->query($q);
				...
				case 3:
					...
					$q = "UPDATE units SET u6 = u6 + '".$speed*rand(49,60)."', u7 = u7 + '".$speed*rand(30,50)."', u8 = u8 + '".$speed*rand(10,20)."' WHERE vref = '" . $wid . "'";
                    $q2 = "UPDATE units SET u1 = u1 + '".$speed*rand(120,450)."',u2 = u2 + '".$speed*rand(104,289)."',u3 = u3 + '".$speed*rand(90,180)."',u4 = u4 + '".$speed*rand(80,160)."',u5 = u5 + '".$speed*rand(60,120)."',u6 = u6 + '".$speed*rand(49,60)."', u7 = u7 + '".$speed*rand(30,50)."',u8 = u8 + '".$speed*rand(20,40)."',u9 = u9 + '".$speed*rand(25,40)."',u10 = u10 + '".$speed*rand(7,20)."',u11 = u11 + '".$speed*rand(3,19)."' WHERE vref = '" . $wid . "'";
					$database->query($q2); 
					$database->query($q);
				...
				case 5:
					...
					$q = "UPDATE units SET u6 = u6 + '".$speed*rand(49,60)."', u7 = u7 + '".$speed*rand(30,50)."' WHERE vref = '" . $wid . "'";
                     $q2 = "UPDATE units SET u1 = u1 + '".$speed*rand(120,450)."',u2 = u2 + '".$speed*rand(104,289)."',u3 = u3 + '".$speed*rand(90,180)."',u4 = u4 + '".$speed*rand(80,160)."',u5 = u5 + '".$speed*rand(60,120)."',u6 = u6 + '".$speed*rand(49,60)."', u7 = u7 + '".$speed*rand(30,50)."',u8 = u8 + '".$speed*rand(20,40)."',u9 = u9 + '".$speed*rand(25,40)."',u10 = u10 + '".$speed*rand(7,20)."',u11 = u11 + '".$speed*rand(3,19)."' WHERE vref = '" . $wid . "'";
					$database->query($q2);
					$database->query($q);
				...
				case 8:
					...
					$q = "UPDATE units SET u1 = u1 + '".$speed*rand(120,450)."', u2 = u2 + '".$speed*rand(10,20)."', u4 = u4 + '".$speed*rand(10,20)."' WHERE vref = '" . $wid . "'";
