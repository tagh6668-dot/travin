...
*/
        ...
        $html = '<div id="build" class="exchangeResources"><p class="npc_desc">با استفاده از بازار می‌توانید منابع را هر طور که می‌خواهید توزیع یا تقسیم کنید.</p><input
    ...
    <p id="submitButton" class="disableButtonHandler">
        <button type="submit" value="Redeem" id="npc_market_button" class="gold " title="توزیع" coins="3">
            <div class="button-container addHoverClick">
                <div class="button-background">
                    <div class="buttonStart">
                        <div class="buttonEnd">
                ...
                <div class="button-content">توزیع<img src="img/x.gif" class="goldIcon" alt=""/><span class="goldValue">3</span>
                </div>
            </div>
        </button>
    ...
    <p id="submitText">
        <button type="button" id="button54872383d13d2" class="gold "
            ...
            <div class="button-container addHoverClick">
                ...
                <div class="button-content">توزیع منابع</div>
            </div>
        </button>
            ...
            if ($(\'buttonq14\')) {
                ...
                $html .= '<div class="header">
                        ...
                        <div class="headerPlayerInfo">
                                '.($_POST['activeTab'] == 'buyGold' ? '<div id="locationSelector">'.$lang['Plus']['Location'].':<select name="location" class="buyGoldLocation"><option value="2" selected="">فارسی</option></select></div>' : '').'
